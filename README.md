...
AWSサービスの作成履歴として、手動構築・CloudFormation・Terraformでの構築をまとめた学習用リポジトリです。  
...
### ・27_CloudFormation実演の課題提出 https://github.com/MihoDaijo/aws-study/pull/5

### ・31_CloudFormationを使った運用監視の環境構築の課題提出 https://github.com/MihoDaijo/aws-study/pull/6

### ・33_Terraformを使ったインフラのコード化と自動化の課題提出 https://github.com/MihoDaijo/aws-study/pull/7

### ・40_インフラ環境の自動テストの課題提出 https://github.com/MihoDaijo/aws-study/pull/8

### ・41_GitHubActionsの解説_CD環境構築の課題提出 https://github.com/MihoDaijo/aws-study/pull/32

### ・43_Ansibleを使った環境構築の完全自動化の課題提出 https://github.com/MihoDaijo/aws-study/pull/55
