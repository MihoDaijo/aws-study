...
- 手動構築だけで終わらせず、CloudFormation、Terraform と段階的にコード化に取り組みました。
- GitHub Actions や Ansible にも触れ、インフラ構築や自動化の流れを学びました。
- AWSサービスを個別に学ぶだけでなく、サービス同士のつながりを意識して構成を理解するよう努めました。
...
- AWS の主要サービスに関する基礎理解
- CloudFormation、Terraform を通じた IaC の基礎的な理解
- Terraform を使ったインフラコード化の基礎
- 自動化や運用も含めてインフラ全体を捉える意識

---

## 今後取り組みたいこと

- Terraform のモジュール設計について、さらに理解を深めること
- AWS 環境のセキュリティや監視設計について学ぶこと
- GitHub Actions や Ansible などの自動化について、理解を深めながら実践を重ねること
- インフラエンジニアとして、実務に近い形で経験を積むこと
